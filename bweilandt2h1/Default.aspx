<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="bweilandt2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6C" runat="server" Width="40px">13</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox7A" runat="server">November 1, 2020</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox8A" runat="server">November 1, 2020</asp:TextBox>
                <asp:TextBox ID="TextBox8Result" runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
